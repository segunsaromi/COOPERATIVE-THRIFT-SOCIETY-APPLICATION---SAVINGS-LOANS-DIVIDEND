...
<table width="100%" border="0" class="table table-striped">
  <tr>
    <td width="39%" rowspan="5"><img name="" src="imageupload/<?php if ($userPass['Passport'] <> "") {echo $userPass['Passport'];} else {echo "no-image.jpg";} ?>" width="115" height="120" alt=""></td>
  ...
  <tr>
    <td height="52" colspan="3"><span style="color:#030"><strong>PERSONAL INFORMATION (SECTION A)</strong></span></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td><strong>To:</strong> <span><?php echo $prito; ?></span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<?php }?>  <tr>
  ...
  <tr>
    <td colspan="3"><strong>Address:</strong> <span><?php echo $nokadd; ?></span></td>
    </tr>
  <tr>
  ...
  <tr>
    <td colspan="3">Please ensure you verify every information entered. After submission correction for any information here will attract a penalty fee. 
</td>
    </tr>  <tr>
    <td colspan="3">						<form method="post" action="final.php">
	<input name="final" type="checkbox" value="final" required>
	<span style="font-size:8; color:#F00">I 
	<?php echo $sname; echo " "; echo $fname; echo " "; echo $oname; ?> Agree to Yaba College of Technology Center for Continuous Studies Terms and Conditions </span>
	<hr />
				
				<div class="form-group">
					<button class="btn btn-primary" onclick="return confirm('Are you sure you want to do a final Submission of your Application?')"> - FINAL APPLICATION SUBMISSION - </button>
				</div>
...
<?php if (($userSubmit['Payment'] == 0) or ($userSubmit['Information'] == 0) or ($userSubmit['Passport'] == 0) or ($userSubmit['Verification'] == 0) or ($userSubmit['Olevel'] == 0)){?>
<div id="form-content">
        <div class="col-lg-12">
        ...
        <br>
        <h4>YOU CAN NOT SUBMIT YOUR APPLICATION UNTIL YOU HAVE COMPLETED EVERY INFORMATION REQUIRED AND YOUR PROFILE STATUS SHOWS <img src="1.jpg" width="40" height="40" alt=""> ALL THROUGH</h4>
