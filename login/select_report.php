...
<div style="background-image: url(../onlineapp/ccslogo/header.jpg); background-repeat: no-repeat center center; background-size: cover; height: 150px"></div>
	...
	<div class="container">
	  <div class="col-lg-12">
		...
		<div class="row">
		<br>
		<h4>EXTRACT MANDATE REPORT</h4><br>
			<div id="form-content">


			<form method="post" action="extract_detail.php" id="reg-form" autocomplete="off">
			  <div class="form-group">							  <label>Date to Extract</label>

<select name="dateo" class="form-control" required>
  <option value="" selected>-- SELECT DATE --</option>
  <?php $querysel=mysqli_query($conn,"SELECT DISTINCT print_date FROM loanrequest_tbl WHERE print_date > '0'"); 
  ...
  <option value="<?php echo $queryseen['print_date']; ?>"><?php echo $queryseen['print_date']; ?></option> <?php } ?>
                ...
                <input name="extractloan" type="checkbox" value="agree" required> I agree to Cooperative Terms and Condition
				</div>
