...
<p>Their  particulars with the amount approved for each person are as specified below.</p></td>
 ...
 $mandate=mysqli_query($conn, "SELECT * FROM loanrequest_tbl WHERE loan_status='1' and msg='0' and loan_complete='0'"); 
...
$date=date('Y-m-d'); 
if ($mandate and $member and $bank){$msgquery=mysqli_query($conn,"UPDATE loanrequest_tbl SET msg='1', print_date='$date' WHERE loan_status='1'");} 
