...
<div style="background-image: url(../onlineapp/ccslogo/header.jpg); background-repeat: no-repeat center center; background-size: cover; height: 150px"></div>
  ...
  <tr>
    <td colspan="4"><strong><?php echo @$_SESSION['success']; ?></strong></span></td>
    </tr>
  <tr>
...
</table></div><br><form method="post" action="submitsavings.php" id="reg-form" autocomplete="off">
				<div class="form-group">
<label>Please Select Month for Deposit</label>
:
<input name="date_deposit" type="month">  
				</div>				
                <div class="form-group">
