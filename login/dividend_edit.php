...
<table width="100%" border="0" class="table table-striped">
  <tr>
    <td colspan="5">EDIT/DELETE DIVIDEND</td>
    </tr>
  <tr>
    ...
    <td><strong>Activate</strong></td>  </tr>
<?php 
$conn = mysqli_connect('localhost','root','','cooperative');
$detaila = mysqli_query($conn,"SELECT DISTINCT div_id,div_date,div_class FROM dividend_tbl");
while ($detailfetcha=mysqli_fetch_array($detaila)){?>  
<?php

//$loan_id=$detailfetcha['loan_id'];
$div_id=$detailfetcha['div_id'];
$div_date=$detailfetcha['div_date'];
$div_class=$detailfetcha['div_class'];
?>
<tr>
    <td><?php echo $div_id; ?></td>
    <td><?php echo $div_date; ?></td>
    <td><?php echo $div_class; ?></td>
<td><a href="dividend_delete.php?page=null&div_id=<?php echo $div_id; ?>" title="<?php echo $div_id; ?>">-|-</a></td>  
<td><a href="dividend_activate.php?page=null&div_id=<?php echo $div_id; ?>" title="<?php echo $div_id; ?>">-|-</a></td>  </tr> <?php }?>
</table><br><br>
		  </div>
