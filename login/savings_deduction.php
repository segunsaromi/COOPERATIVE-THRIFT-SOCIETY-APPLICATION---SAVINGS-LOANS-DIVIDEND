...
<div style="background-image: url(../onlineapp/ccslogo/header.jpg); background-repeat: no-repeat center center; background-size: cover; height: 150px"></div>
	...
	<div class="container">
	  <div class="col-lg-12">
		...
		<div class="row">
		<br>
		<h4>DEDUCTION SETUP</h4><br>
			<div id="form-content">


			<form method="post" action="deductionupdate.php" id="reg-form" autocomplete="off">
			  <div class="form-group">							  <label>Month to Start Deduction</label>

                    <input type="date" class="form-control" name="deduction_month" id="lname" placeholder="Select Date to Start Deduction" required />
				</div>
                ...
                <input name="deduction" type="checkbox" value="agree" required> I agree to Cooperative Terms and Condition
				</div>
				
				<hr />
				
				<div class="form-group">
					<button class="btn btn-primary"> -Start Deduction- </button>
				</div>
			</form>
