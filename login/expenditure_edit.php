...
while (!$unique_ref_found) {  
    ...
    $query = mysqli_query($con, "SELECT `exp_id` FROM ` expenditure_tbl` 
              WHERE `exp_id`='".$unique_ref."'");  
...
<div style="background-image: url(../onlineapp/ccslogo/header.jpg); background-repeat: no-repeat center center; background-size: cover; height: 150px"></div>
	...
	<div class="container">
	  <div class="col-lg-12">
		...
		<div class="row">
		<br>
		<h4>ORGANISATION EXPENDITURE</h4><br>
			<div id="form-content">
...
<div class="form-group">							  <label>Expenditure Date</label>

                    <input type="date" class="form-control" name="exp_date" id="lname" placeholder="Select Date for Expenditure" required />
				</div>

<div class="form-group">							  <label>Description</label>

					<input type="text" onkeyup="this.value = this.value.toUpperCase();" pattern="^[A-Za-z0-9 -]+$" class="form-control" name="exp_des" id="lname" placeholder="Describe the Expenses" required />
				</div>
...
<div class="form-group">							  <label>Amount (e.g. 1234567890)</label>
                ...
                <input name="expenditure" type="checkbox" value="agree" required> I agree to Cooperative Terms and Condition
				</div>
