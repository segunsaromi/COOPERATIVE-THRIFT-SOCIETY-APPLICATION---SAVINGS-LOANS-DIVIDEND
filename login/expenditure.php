...
<table width="100%" border="0" class="table table-striped">
  <tr>
    <td colspan="5">EDIT/DELETE EXPENDITURE</td>
    </tr>
  <tr>
...
<?php 
$conn = mysqli_connect('localhost','root','','cooperative');
$detaila = mysqli_query($conn,"SELECT * FROM expenditure_tbl");
...
$exp_id=$detailfetcha['exp_id'];
$exp_des=$detailfetcha['exp_des'];
$amount=$detailfetcha['amount'];
$exp_date=$detailfetcha['exp_date'];
?>
<tr>
    <td><?php echo $exp_id; ?></td>
    <td><?php echo $exp_des; ?></td>
    <td><?php echo $amount; ?></td>
    <td><?php echo $exp_date; ?></td>
<td><a href="expenditure_del.php?page=null&exp_id=<?php echo $exp_id; ?>" title="<?php echo $exp_id; ?>">-|-</a></td>  </tr> <?php }?>
</table><br><br>
		  </div>
